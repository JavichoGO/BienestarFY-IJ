...
public class Actividad implements Serializable {
    ...
    public Actividad(int idActividad, String nombreActividad, String descripcionActividad,String duracionActividad, Usuario usuario, TipoActividad tipoactividad) {
